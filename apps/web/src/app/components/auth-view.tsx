            ...
            <Card sx={{ height: "100%" }}>
              <CardContent sx={{ display: "flex", flexDirection: "column", gap: 3, p: { xs: 3, md: 5 } }}>
                ...
                <Typography color="text.secondary" sx={{ maxWidth: 560 }} variant="body1">
                  Define a coverage radius, visualize recent storms on the map, and show a lightweight admin workflow
                  for alerts. Use <strong>admin@stormdemo.local</strong> during sign-up to unlock the admin dashboard.
                </Typography>
          ...
          <Grid size={{ xs: 12, md: 5 }}>
            <Card>
              <CardContent sx={{ p: { xs: 3, md: 4 } }}>
                <Tabs
                  onChange={(_event: SyntheticEvent, value: "login" | "signup") => setAuthMode(value)}
                  sx={{ mb: 3 }}
                  value={authMode}
                >
